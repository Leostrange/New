    ...
    implements q
{
    ...
    du(ds ds1, int i1, int j1, int k1, int l1, CharSequence charsequence, int i2)
    {
        s = 0;
        w = 16;
        c = 0;
    ...
    public final CharSequence a(dz.a a1)
    {
...
_L5:
    ...
    public final MenuItem setChecked(boolean flag)
    {
        if ((w & 4) != 0)
        {
            ...
            while (i1 < k1) 
            {
                du du1 = (du)ds1.c.get(i1);
                if (du1.getGroupId() == j1 && du1.e() && du1.isCheckable())
                {
                    if (du1 == this)
                    {
                        flag = true;

...
public class cz extends Drawable
    implements android.graphics.drawable.Drawable.Callback
{
    ...
    {
        mDrawable.setChangingConfigurations(j);
    }

    ...
    implements android.view.View.OnTouchListener
{
    static final class a
    {
        ...
        final float a(long l1)
        {
            ...
            if (i < 0L || l1 < i)
            {
                return cg.a((float)(l1 - e) / (float)a) * 0.5F;
            } else
            {
                long l2 = i;
                float f1 = j;
                float f2 = j;
                return cg.a((float)(l1 - l2) / (float)k) * f2 + (1.0F - f1);
            }
        }
...
_L3:
    ...
    static boolean b(cg cg1)
    {
        return cg1.m;
    }

    static boolean c(cg cg1)
    {
        cg1.m = false;
        return false;
    }
    ...
    static boolean f(cg cg1)
    {
        cg1.o = false;
        return false;
    }

    static boolean g(cg cg1)
    {
        return cg1.n;
    }

    static boolean h(cg cg1)
    {
        cg1.n = false;
        return false;
    }

    static void i(cg cg1)
    {
        long l1 = SystemClock.uptimeMillis();
        MotionEvent motionevent = MotionEvent.obtain(l1, l1, 3, 0.0F, 0.0F, 0);
        cg1.c.onTouchEvent(motionevent);
        motionevent.recycle();
    }

    static View j(cg cg1)
    {
        return cg1.c;
    }

    public final cg a(boolean flag)
    {
        if (p && !flag)
        {
            b();

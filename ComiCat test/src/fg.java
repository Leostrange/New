...
public final class fg extends cr
    implements android.view.View.OnClickListener
{
    static final class a
    {
        ...
        public a(View view)
        {
            ...
            e = (ImageView)view.findViewById(cv.f.edit_query);
        }
    }
    ...
    public fg(Context context, SearchView searchview, SearchableInfo searchableinfo, WeakHashMap weakhashmap)
    {
...
_L5:
    ...
    public final View a(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        ((ImageView)context.findViewById(cv.f.edit_query)).setImageResource(p);
        return context;
    }
    ...
    public final void a(View view, Cursor cursor)
    {
        ...
        if (a1.b != null)
        {
            ...
            if (obj != null)
            {
                ...
                {
                    view = new TypedValue();
                    d.getTheme().resolveAttribute(cv.a.textColorSearchUrl, view, true);

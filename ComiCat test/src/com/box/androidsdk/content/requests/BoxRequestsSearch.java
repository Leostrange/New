...
//            BoxRequestItem, BoxCacheableRequest

public class BoxRequestsSearch
{
    public static class Search extends BoxRequestItem
        implements BoxCacheableRequest
    {
        ...
        public Search limitSizeRange(long l, long l1)
        {
        ...
        public Search limitType(String s)
        {
            limitValueForKey("type", s);
            return this;
        }

        public Search limitValueForKey(String s, String s1)
        {
            mQueryMap.put(s, s1);
            return this;
        }
        ...
        public Search(String s, String s1, BoxSession boxsession)
        {
    ...
    public static final class Search.Scope extends Enum
    {

        private static final Search.Scope $VALUES[];
        public static final Search.Scope ENTERPRISE_CONTENT;
        public static final Search.Scope USER_CONTENT;

        public static Search.Scope valueOf(String s)
        {
            return (Search.Scope)Enum.valueOf(com/box/androidsdk/content/requests/BoxRequestsSearch$Search$Scope, s);
        }

        public static Search.Scope[] values()
        {
            return (Search.Scope[])$VALUES.clone();
        }

        static 
        {
            USER_CONTENT = new Search.Scope("USER_CONTENT", 0);
            ENTERPRISE_CONTENT = new Search.Scope("ENTERPRISE_CONTENT", 1);
            $VALUES = (new Search.Scope[] {
                USER_CONTENT, ENTERPRISE_CONTENT
            });
        }

        private Search.Scope(String s, int i)
        {
            super(s, i);
        }
    }

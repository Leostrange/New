...
abstract class BoxRequestItemCopy extends BoxRequestItem
{

    public BoxRequestItemCopy(Class class1, String s, String s1, String s2, BoxSession boxsession)
    {
        super(class1, s, s2, boxsession);

...
public static final class mValue extends Enum
{
    ...
    {
        return (toString)Enum.valueOf(com/box/androidsdk/content/models/BoxUploadEmail$Access, s);
    }
    ...
    static 
    {
        OPEN = new <init>("OPEN", 0, "open");
        COLLABORATORS = new <init>("COLLABORATORS", 1, "collaborators");
        $VALUES = (new .VALUES[] {
            OPEN, COLLABORATORS
        });
    }

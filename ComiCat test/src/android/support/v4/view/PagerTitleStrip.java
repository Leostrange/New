    ...
    implements ViewPager.a
{
        ...
        implements ViewPager.d, ViewPager.e
    {
        ...
        public final void a(bd bd1, bd bd2)
        {
            a.a(bd1, bd2);
        }
...
_L4:
    ...
    final void a(int i1, bd bd1)
    {
        ...
        if (i1 > 0 && bd1 != null)
        {
            charsequence = bd1.getPageTitle(i1 - 1);
        } else
        {
            charsequence = null;
        }
        ...
        if (bd1 != null && i1 < j1)
        {
            charsequence = bd1.getPageTitle(i1);
        } else
        {
            charsequence = null;
        }
    ...
    final void a(bd bd1, bd bd2)
    {
        if (bd1 != null)
        {
            bd1.unregisterDataSetObserver(l);
            m = null;
        }
        if (bd2 != null)
        {
            bd2.registerDataSetObserver(l);
            m = new WeakReference(bd2);
        }
        if (a != null)
        {
            f = -1;
            g = -1F;
            a(a.getCurrentItem(), bd2);
            requestLayout();
        }
    }
    ...
    protected void onAttachedToWindow()
    {
        ...
        obj = (ViewPager)obj;
        bd bd1 = ((ViewPager) (obj)).getAdapter();
        ((ViewPager) (obj)).a(l);

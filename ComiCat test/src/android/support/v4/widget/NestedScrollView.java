    ...
    implements ay, ba
{
    ...
    static final class a extends al
    {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityevent)
        {
            ...
            i1 = view.getScrollX();
            cd.a.c(((cd) (accessibilityevent)).b, i1);
            i1 = view.getScrollY();
            cd.a.d(((cd) (accessibilityevent)).b, i1);
            i1 = view.getScrollX();
            cd.a.f(((cd) (accessibilityevent)).b, i1);
            i1 = NestedScrollView.a(view);
            cd.a.g(((cd) (accessibilityevent)).b, i1);
        }
        ...
        public final void onInitializeAccessibilityNodeInfo(View view, bz bz1)
        {
            ...
            view = (NestedScrollView)view;
            bz1.b(android/widget/ScrollView.getName());
            if (view.isEnabled())
            {
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (ax.b(motionevent, i1) == q)
        {
            ...
            f = (int)ax.d(motionevent, i1);
            q = ax.b(motionevent, i1);
            if (k != null)
            {
                k.clear();
            }
...
_L10:
    ...
    {
        if ((ax.d(motionevent) & 2) == 0) goto _L2; else goto _L1
_L1:
...
_L3:
        ...
        int l1;
        float f1;
        if (j || (f1 = ax.e(motionevent, 9)) == 0.0F)
        {
...
_L8:
        d.a((float)i1 / (float)getHeight(), ax.c(motionevent, i2) / (float)getWidth());
        if (!e.a())
        {
            e.c();
        }
...
_L9:
        if (l1 > j2)
        {
            e.a((float)i1 / (float)getHeight(), 1.0F - ax.c(motionevent, i2) / (float)getWidth());
            if (!d.a())
            {
                d.c();
            }
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L6:
        int k1 = ax.b(motionevent);
        f = (int)ax.d(motionevent, k1);
        q = ax.b(motionevent, k1);
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        f = (int)ax.d(motionevent, ax.a(motionevent, q));

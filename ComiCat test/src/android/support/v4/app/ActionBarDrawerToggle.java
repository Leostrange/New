    ...
    implements android.support.v4.widget.DrawerLayout.f
{
        ...
        implements android.graphics.drawable.Drawable.Callback
    {
        ...
        public void draw(Canvas canvas)
        {
            ...
            boolean flag;
            int j;
            if (bh.h(mActivity.getWindow().getDecorView()) == 1)
            {
                flag = true;
            } else
            {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerlayout, boolean flag, int i, int j, int k)
    {
        ...
        mDrawerImage = e.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration)
    {
        ...
        mDrawerImage = e.getDrawable(mActivity, mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuitem)
    {
        if (menuitem != null && menuitem.getItemId() == 0x102002c && mDrawerIndicatorEnabled)
        {
            if (mDrawerLayout.c())
            {
                mDrawerLayout.c(0x800003);
            } else
            {
                mDrawerLayout.b(0x800003);
            }
            return true;
        } else
        {
    ...
    public void setHomeAsUpIndicator(int i)
    {
        ...
        if (i != 0)
        {
            drawable = e.getDrawable(mActivity, i);
        }

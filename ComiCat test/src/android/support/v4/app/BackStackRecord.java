...
_L10:
    ...
    private void callSharedElementEnd(TransitionState transitionstate, Fragment fragment, Fragment fragment1, boolean flag, ab ab1)
    {
        if (flag)
        {
        ...
        {
            transitionstate.onSharedElementEnd(new ArrayList(ab1.keySet()), new ArrayList(ab1.values()), null);
        }
    }

    private static Object captureExitingViews(Object obj, Fragment fragment, ArrayList arraylist, ab ab1, View view)
    {
        Object obj1 = obj;
        if (obj != null)
        {
            obj1 = FragmentTransitionCompat21.captureExitingViews(obj, fragment.getView(), arraylist, ab1, view);
        }
        return obj1;
    }
    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        if (obj2 != null)
        {
            ...
            arraylist.addAll(((ab) (obj)).values());
            if (flag)
            {
            ...
            {
                sparsearray1.onSharedElementStart(new ArrayList(((ab) (obj)).keySet()), new ArrayList(((ab) (obj)).values()), null);
                sparsearray = ((SparseArray) (obj));
            }
        }
    ...
    private ab mapEnteringSharedElements(TransitionState transitionstate, Fragment fragment, boolean flag)
    {
        ab ab1;
label0:
        {
            ...
            if (fragment != null)
            {
                ...
                {
                    FragmentTransitionCompat21.findNamedViews(ab1, fragment);
                    if (!flag)
                    {
                        break label0;
                    }
                    transitionstate = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, ab1);
                }
            }
            return transitionstate;
        }
        ag.a(ab1, mSharedElementTargetNames);
        return ab1;
    }

    private ab mapSharedElementsIn(TransitionState transitionstate, boolean flag, Fragment fragment)
    {
        ab ab1 = mapEnteringSharedElements(transitionstate, fragment, flag);
        if (flag)
        {
            if (fragment.mExitTransitionCallback != null)
            {
                fragment.mExitTransitionCallback.onMapSharedElements(mSharedElementTargetNames, ab1);
            }
            setBackNameOverrides(transitionstate, ab1, true);
            return ab1;
        }
        if (fragment.mEnterTransitionCallback != null)
        {
            fragment.mEnterTransitionCallback.onMapSharedElements(mSharedElementTargetNames, ab1);
        }
        setNameOverrides(transitionstate, ab1, true);
        return ab1;
    }
        ...
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new android.view.ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw()
            {
                ...
                if (sharedElementTransition != null)
                {
                    ...
                    ab ab1 = mapSharedElementsIn(state, isBack, inFragment);
                    sharedElementTargets.add(state.nonExistentView);
                    sharedElementTargets.addAll(ab1.values());
                    FragmentTransitionCompat21.addTargets(sharedElementTransition, sharedElementTargets);
                    setEpicenterIn(ab1, state);
                    callSharedElementEnd(state, inFragment, outFragment, isBack, ab1);
                }
                return true;
            }
    ...
    private static ab remapNames(ArrayList arraylist, ArrayList arraylist1, ab ab1)
    {
        if (ab1.isEmpty())
        {
            return ab1;
        ...
        for (int i = 0; i < j; i++)
        {
            View view = (View)ab1.get(arraylist.get(i));
            if (view != null)
            {
                ab2.put(arraylist1.get(i), view);
            }
        }
    ...
    private ab remapSharedElements(TransitionState transitionstate, Fragment fragment, boolean flag)
    {
        ab ab2 = new ab();
        ab ab1 = ab2;
        if (mSharedElementSourceNames != null)
        {
            FragmentTransitionCompat21.findNamedViews(ab2, fragment.getView());
            if (flag)
            {
                ag.a(ab2, mSharedElementTargetNames);
                ab1 = ab2;
            } else
            {
                ab1 = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, ab2);
            }
        }
        if (flag)
        {
            ...
            setBackNameOverrides(transitionstate, ab1, false);
            return ab1;
        }
        if (fragment.mExitTransitionCallback != null)
        {
        ...
        setNameOverrides(transitionstate, ab1, false);
        return ab1;
    }

    private void setBackNameOverrides(TransitionState transitionstate, ab ab1, boolean flag)
    {
        int i;
        int j;
        ...
        while (j < i) 
        {
            ...
            Object obj = (View)ab1.get((String)mSharedElementTargetNames.get(j));
            if (obj != null)
            {
    ...
    private void setEpicenterIn(ab ab1, TransitionState transitionstate)
    {
        if (mSharedElementTargetNames != null && !ab1.isEmpty())
        {
            ab1 = (View)ab1.get(mSharedElementTargetNames.get(0));
            if (ab1 != null)
            {
                transitionstate.enteringEpicenterView.epicenter = ab1;
            }
        }
    }
    ...
    private static void setNameOverride(ab ab1, String s, String s1)
    {
...
_L6:
        ...
        if (!s.equals(ab1.c(i))) goto _L4; else goto _L3
_L3:
        ab1.a(i, s1);
_L2:
        return;
...
_L5:
    ...
    private void setNameOverrides(TransitionState transitionstate, ab ab1, boolean flag)
    {
        int j = ab1.size();
        int i = 0;
        while (i < j) 
        {
            String s = (String)ab1.b(i);
            String s1 = FragmentTransitionCompat21.getTransitionName((View)ab1.c(i));
            if (flag)
            {
...
_L10:
    ...
    final int commitInternal(boolean flag)
    {
        ...
        if (FragmentManagerImpl.DEBUG)
        {
            ...
            dump("  ", null, new PrintWriter(new ae("FragmentManager")), null);
        }
        mCommitted = true;
        if (mAddToBackStack)
        {

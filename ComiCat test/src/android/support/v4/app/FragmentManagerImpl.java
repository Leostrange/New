    ...
    implements au
{
    ...
    private void throwException(RuntimeException runtimeexception)
    {
        ...
        Object obj = new PrintWriter(new ae("FragmentManager"));
        if (mActivity != null)
        {
            try
            {
...
_L10:
    ...
    final au getLayoutInflaterFactory()
    {
        return this;
    }
            ...
            if (((FragmentManagerState) (parcelable)).mBackStack != null)
            {
                ...
                while (i1 < ((FragmentManagerState) (parcelable)).mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        ...
                        arraylist.dump("  ", new PrintWriter(new ae("FragmentManager")), false);
                    }

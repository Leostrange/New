    ...
    implements android.view.nPreDrawListener
{
    ...
    public boolean onPreDraw()
    {
        ...
        if (val$sharedElementTransition != null)
        {
            ...
            ab ab1 = BackStackRecord.access$000(BackStackRecord.this, val$state, val$isBack, val$inFragment);
            val$sharedElementTargets.add(val$state.nonExistentView);
            val$sharedElementTargets.addAll(ab1.values());
            FragmentTransitionCompat21.addTargets(val$sharedElementTransition, val$sharedElementTargets);
            BackStackRecord.access$100(BackStackRecord.this, ab1, val$state);
            BackStackRecord.access$200(BackStackRecord.this, val$state, val$inFragment, val$outFragment, val$isBack, ab1);
        }
        return true;
    }

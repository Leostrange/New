    ...
    implements au, ds.a
{
        ...
        implements ew.a
    {
        ...
        public boolean onActionItemClicked(ew ew1, MenuItem menuitem)
        {
            return mWrapped.onActionItemClicked(ew1, menuitem);
        }

        public boolean onCreateActionMode(ew ew1, Menu menu)
        {
            return mWrapped.onCreateActionMode(ew1, menu);
        }

        public void onDestroyActionMode(ew ew1)
        {
            mWrapped.onDestroyActionMode(ew1);
...
_L2:
            if (mActionModeView != null)
            {
                ...
                {
                    bh.w((View)mActionModeView.getParent());
                }
            }
...
_L3:
        ...
        public boolean onPrepareActionMode(ew ew1, Menu menu)
        {
            return mWrapped.onPrepareActionMode(ew1, menu);
        }

        public ActionModeCallbackWrapperV7(ew.a a)
        {
            this$0 = AppCompatDelegateImplV7.this;
            super();
            mWrapped = a;
    ...
    static final class PanelFeatureState
    {
        ...
        final dz getListMenuView(dy.a a)
        {
            if (menu == null)
            {
                return null;
            ...
            {
                listMenuPresenter = new dr(listPresenterContext, cv.h.abc_list_menu_item_layout);
        ...
        final void setMenu(ds ds1)
        {
            if (ds1 != menu)
            {
                ...
                menu = ds1;
                if (ds1 != null && listMenuPresenter != null)
                {
                    ds1.a(listMenuPresenter);
                    return;
                }
            }
        }
        ...
        final void setStyle(Context context)
        {
            ...
            context = new dh(context, 0);
            context.getTheme().setTo(theme);
            listPresenterContext = context;
            context = context.obtainStyledAttributes(cv.k.Theme);
            background = context.getResourceId(cv.k.Theme_panelBackground, 0);
            windowAnimations = context.getResourceId(cv.k.Theme_android_windowAnimationStyle, 0);
            context.recycle();
        }
...
label0:
            {
                ...
                ds1 = appcompatdelegateimplv7.findMenuPanel(ds1);
                if (ds1 != null)
                {
                    if (!flag1)
                    {
                    ...
                    callOnPanelClosed(((PanelFeatureState) (ds1)).featureId, ds1, ds2);
                    closePanel(ds1, true);
                }
                return;
            }
    ...
    private void applyFixedSizeWindow(ContentFrameLayout contentframelayout)
    {
        ...
        TypedArray typedarray = mContext.obtainStyledAttributes(cv.k.Theme);
        typedarray.getValue(cv.k.Theme_windowMinWidthMajor, contentframelayout.getMinWidthMajor());
        typedarray.getValue(cv.k.Theme_windowMinWidthMinor, contentframelayout.getMinWidthMinor());
        if (typedarray.hasValue(cv.k.Theme_windowFixedWidthMajor))
        {
            typedarray.getValue(cv.k.Theme_windowFixedWidthMajor, contentframelayout.getFixedWidthMajor());
        }
        if (typedarray.hasValue(cv.k.Theme_windowFixedWidthMinor))
        {
            typedarray.getValue(cv.k.Theme_windowFixedWidthMinor, contentframelayout.getFixedWidthMinor());
        }
        if (typedarray.hasValue(cv.k.Theme_windowFixedHeightMajor))
        {
            typedarray.getValue(cv.k.Theme_windowFixedHeightMajor, contentframelayout.getFixedHeightMajor());
        }
        if (typedarray.hasValue(cv.k.Theme_windowFixedHeightMinor))
        {
            typedarray.getValue(cv.k.Theme_windowFixedHeightMinor, contentframelayout.getFixedHeightMinor());
        }
        typedarray.recycle();
    ...
    private void checkCloseActionMenu(ds ds1)
    {
        ...
        mDecorContentParent.f();
        android.view.Window.Callback callback = getWindowCallback();
        if (callback != null && !isDestroyed())
        {
            callback.onPanelClosed(8, ds1);
        }
    ...
    {
        if (flag && panelfeaturestate.featureId == 0 && mDecorContentParent != null && mDecorContentParent.b())
        {
...
_L3:
        mSubDecor = (ViewGroup)((LayoutInflater) (obj)).inflate(cv.h.abc_dialog_title_material, null);
...
_L4:
        ...
        {
            obj = new TypedValue();
            mContext.getTheme().resolveAttribute(cv.a.actionBarTheme, ((TypedValue) (obj)), true);
            if (((TypedValue) (obj)).resourceId != 0)
            {
                obj = new dh(mContext, ((TypedValue) (obj)).resourceId);
            } else
            {
                obj = mContext;
            }
            mSubDecor = (ViewGroup)LayoutInflater.from(((Context) (obj))).inflate(cv.h.abc_screen_toolbar, null);
            mDecorContentParent = (ei)mSubDecor.findViewById(cv.f.decor_content_parent);
            mDecorContentParent.setWindowCallback(getWindowCallback());
            if (mOverlayActionBar)
            {
                mDecorContentParent.a(9);
            }
            if (mFeatureProgress)
            {
                mDecorContentParent.a(2);
            }
            if (mFeatureIndeterminateProgress)
            {
                mDecorContentParent.a(5);
            }
        }
...
_L2:
        ...
        {
            mSubDecor = (ViewGroup)((LayoutInflater) (obj)).inflate(cv.h.abc_screen_simple_overlay_action_mode, null);
        } else
        {
            mSubDecor = (ViewGroup)((LayoutInflater) (obj)).inflate(cv.h.abc_screen_simple, null);
        }
        if (android.os.Build.VERSION.SDK_INT >= 21)
        {
            bh.a(mSubDecor, new bc() {

                final AppCompatDelegateImplV7 this$0;

                public bw onApplyWindowInsets(View view1, bw bw1)
                {
                    int i = bw1.b();
        ...
        {
            ((el)mSubDecor).setOnFitSystemWindowsListener(new el.a() {
...
_L5:
        ...
        {
            mTitleView = (TextView)mSubDecor.findViewById(cv.f.title);
        }
        eu.b(mSubDecor);
        Object obj2 = (ViewGroup)mWindow.findViewById(0x1020002);
        Object obj1 = (ContentFrameLayout)mSubDecor.findViewById(cv.f.action_bar_activity_content);
        View view;
...
_L1:
        ...
        theme1.resolveAttribute(cv.a.actionBarTheme, typedvalue, true);
        obj = null;
        ...
        if (typedvalue.resourceId != 0)
        {
            ...
            ((android.content.res.Resources.Theme) (obj)).resolveAttribute(cv.a.actionBarWidgetTheme, typedvalue, true);
        } else
        {
            theme1.resolveAttribute(cv.a.actionBarWidgetTheme, typedvalue, true);
        }
...
_L3:
        obj = new dh(context, 0);
        ((Context) (obj)).getTheme().setTo(theme);
_L5:
        obj = new ds(((Context) (obj)));
        ((ds) (obj)).a(this);
        panelfeaturestate.setMenu(((ds) (obj)));
        return true;
_L2:
        obj = context;
...
_L4:
    ...
    private void invalidatePanelMenu(int i)
    {
        ...
        {
            bh.a(mWindowDecor, mInvalidatePanelMenuRunnable);
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyevent)
    {
        ...
        if (i != 0 || mDecorContentParent == null || !mDecorContentParent.a() || bl.b(ViewConfiguration.get(mContext))) goto _L2; else goto _L1
_L1:
        if (mDecorContentParent.b()) goto _L4; else goto _L3
_L3:
        if (isDestroyed() || !preparePanel(panelfeaturestate, keyevent)) goto _L6; else goto _L5
_L5:
        boolean flag = mDecorContentParent.d();
_L8:
        if (flag)
        {
...
_L2:
        ...
        if (panelfeaturestate.createdPanelView != null || i && (peekSupportActionBar() instanceof dd))
        {
...
_L3:
    ...
    private void reopenMenu(ds ds1, boolean flag)
    {
        if (mDecorContentParent == null || !mDecorContentParent.a() || bl.b(ViewConfiguration.get(mContext)) && !mDecorContentParent.c())
        {
            break MISSING_BLOCK_LABEL_211;
        }
        ds1 = getWindowCallback();
        if (mDecorContentParent.b() && flag) goto _L2; else goto _L1
_L1:
        if (ds1 != null && !isDestroyed())
        {
            ...
            if (panelfeaturestate.menu != null && !panelfeaturestate.refreshMenuContent && ds1.onPreparePanel(0, panelfeaturestate.createdPanelView, panelfeaturestate.menu))
            {
                ds1.onMenuOpened(8, panelfeaturestate.menu);
                mDecorContentParent.d();
            }
        }
_L4:
        return;
_L2:
        mDecorContentParent.e();
        if (isDestroyed()) goto _L4; else goto _L3
_L3:
        ds1.onPanelClosed(8, getPanelState(0, true).menu);
        return;
        ds1 = getPanelState(0, true);
        ds1.refreshDecorView = true;
        closePanel(ds1, false);
        openPanel(ds1, null);
        return;
    }
            ...
            if (mActionModeView.isShown())
            {
                ...
                if (((android.view.ViewGroup.MarginLayoutParams) (obj)).topMargin != j)
                {
                    ...
                    if (mStatusGuard == null)
                    {
                        ...
                        mStatusGuard.setBackgroundColor(mContext.getResources().getColor(cv.c.abc_input_method_navigation_guard));
...
_L1:
        de1 = new de((Activity)mOriginalWindowCallback, mOverlayActionBar);
_L4:
        if (de1 != null)
        {
            de1.setDefaultDisplayHomeAsUpEnabled(mEnableDefaultActionBarUp);
        }
        return de1;
_L2:
        if (mOriginalWindowCallback instanceof Dialog)
        {
            de1 = new de((Dialog)mOriginalWindowCallback);
        }
        if (true) goto _L4; else goto _L3
_L3:
    }
    ...
    public View createView(View view, String s, Context context, AttributeSet attributeset)
    {
        ...
        {
            mAppCompatViewInflater = new da();
        }
        if (flag1 && mSubDecorInstalled && view != null && view.getId() != 0x1020002 && !bh.E(view))
        {
            byte0 = 1;
        } else
        {
        ...
        view = da.a(view, attributeset, flag1);
        s.hashCode();
...
_L13:
        ...
        default:
            if (context != view)
            {
                return da1.a(view, s, attributeset);
            } else
            {
                return null;
            }
...
_L4:
    ...
    public boolean onMenuItemSelected(ds ds1, MenuItem menuitem)
    {
        ...
        if (callback != null && !isDestroyed())
        {
            ds1 = findMenuPanel(ds1.k());
            if (ds1 != null)
            {
                return callback.onMenuItemSelected(((PanelFeatureState) (ds1)).featureId, menuitem);
            }
        }
        return false;
    }
    ...
    public void setSupportActionBar(Toolbar toolbar)
    {
        ...
        {
            toolbar = new dd(toolbar, ((Activity)mContext).getTitle(), mAppCompatWindowCallback);
            setSupportActionBar(((ActionBar) (toolbar)));
            mWindow.setCallback(((dd) (toolbar)).a);
            toolbar.invalidateOptionsMenu();
            return;
        }
    }

    public ew startSupportActionMode(ew.a a)
    {
        if (a == null)
        {
        ...
        a = new ActionModeCallbackWrapperV7(a);
        ActionBar actionbar = getSupportActionBar();
        if (actionbar != null)
        {
            mActionMode = actionbar.startActionMode(a);
        ...
        if (mActionMode == null)
        {
            mActionMode = startSupportActionModeFromWindow(a);
        }
        return mActionMode;
    }

    ew startSupportActionModeFromWindow(ew.a a)
    {
        ...
        actionmodecallbackwrapperv7 = new ActionModeCallbackWrapperV7(a);
        ...
        } else
        {
            if (mActionModeView == null)
            {
                if (mIsFloating)
                {
                    ...
                    ((android.content.res.Resources.Theme) (obj1)).resolveAttribute(cv.a.actionBarTheme, ((TypedValue) (obj2)), true);
                    int i;
                    ...
                    mActionModePopup = new PopupWindow(((Context) (obj1)), null, cv.a.actionModePopupWindowStyle);
                    mActionModePopup.setContentView(mActionModeView);
                    mActionModePopup.setWidth(-1);
                    ((Context) (obj1)).getTheme().resolveAttribute(cv.a.actionBarSize, ((TypedValue) (obj2)), true);
            ...
            
            {
                ...
                {
                    ViewStubCompat viewstubcompat = (ViewStubCompat)mSubDecor.findViewById(cv.f.action_mode_bar_stub);
                    if (viewstubcompat != null)
                    {
                        viewstubcompat.setLayoutInflater(LayoutInflater.from(getActionBarThemedContext()));
                        mActionModeView = (ActionBarContextView)viewstubcompat.a();
                    }
                }
            }
            if (mActionModeView != null)
            {
                ...
                obj1 = new di(((Context) (obj1)), ((ActionBarContextView) (obj2)), actionmodecallbackwrapperv7, flag);
                if (a.onCreateActionMode(((ew) (obj1)), ((ew) (obj1)).b()))
                {
                    ((ew) (obj1)).d();
                    mActionModeView.a(((ew) (obj1)));

...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate
{
        ...
        implements ActionBarDrawerToggle.Delegate
    {
        ...
        {
            es es1 = es.a(getActionBarThemedContext(), null, new int[] {
                cv.a.homeAsUpIndicator
            });
    ...
    public MenuInflater getMenuInflater()
    {
        ...
        {
            mMenuInflater = new dk(getActionBarThemedContext());
        }
...
_L3:
    ...
    {
        bundle = mContext.obtainStyledAttributes(cv.k.Theme);
        if (!bundle.hasValue(cv.k.Theme_windowActionBar))
        {
            bundle.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (bundle.getBoolean(cv.k.Theme_windowActionBar, false))
        {
            mHasActionBar = true;
        }
        if (bundle.getBoolean(cv.k.Theme_windowActionBarOverlay, false))
        {
            mOverlayActionBar = true;
        }
        if (bundle.getBoolean(cv.k.Theme_windowActionModeOverlay, false))
        {
            mOverlayActionMode = true;
        }
        mIsFloating = bundle.getBoolean(cv.k.Theme_android_windowIsFloating, false);
        mWindowNoTitle = bundle.getBoolean(cv.k.Theme_windowNoTitle, false);
        bundle.recycle();
    }
    ...
    abstract ew startSupportActionModeFromWindow(ew.a a);

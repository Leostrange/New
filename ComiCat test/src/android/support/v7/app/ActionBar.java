...
public abstract class ActionBar
{
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            gravity = 0;
            context = context.obtainStyledAttributes(attributeset, cv.k.ActionBarLayout);
            gravity = context.getInt(cv.k.ActionBarLayout_android_layout_gravity, 0);
            context.recycle();
        }
    ...
    public ew startActionMode(ew.a a)
    {
        return null;
    }
}

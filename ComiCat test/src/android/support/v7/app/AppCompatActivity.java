    ...
    implements android.support.v4.app.TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider, AppCompatCallback
{
    ...
    public void onSupportActionModeFinished(ew ew)
    {
    }

    public void onSupportActionModeStarted(ew ew)
    {
    }
    ...
    public ew onWindowStartingSupportActionMode(ew.a a)
    {
        return null;
    }
    ...
    {
        return getDelegate().startSupportActionMode(a);
    }

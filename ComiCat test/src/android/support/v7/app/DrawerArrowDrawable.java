...
abstract class DrawerArrowDrawable extends Drawable
{
    ...
    DrawerArrowDrawable(Context context)
    {
        ...
        context = context.getTheme().obtainStyledAttributes(null, cv.k.DrawerArrowToggle, cv.a.drawerArrowStyle, cv.j.Base_Widget_AppCompat_DrawerArrowToggle);
        mPaint.setAntiAlias(true);
        mPaint.setColor(context.getColor(cv.k.DrawerArrowToggle_color, 0));
        mSize = context.getDimensionPixelSize(cv.k.DrawerArrowToggle_drawableSize, 0);
        mBarSize = Math.round(context.getDimension(cv.k.DrawerArrowToggle_barSize, 0.0F));
        mTopBottomArrowSize = Math.round(context.getDimension(cv.k.DrawerArrowToggle_topBottomBarArrowSize, 0.0F));
        mBarThickness = context.getDimension(cv.k.DrawerArrowToggle_thickness, 0.0F);
        mBarGap = Math.round(context.getDimension(cv.k.DrawerArrowToggle_gapBetweenBars, 0.0F));
        mSpin = context.getBoolean(cv.k.DrawerArrowToggle_spinBars, true);
        mMiddleArrowSize = context.getDimension(cv.k.DrawerArrowToggle_middleBarArrowSize, 0.0F);

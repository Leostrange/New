...
public final class ViewStubCompat extends View
{
    ...
    public ViewStubCompat(Context context, AttributeSet attributeset, int i)
    {
        ...
        a = 0;
        context = context.obtainStyledAttributes(attributeset, cv.k.ViewStubCompat, i, 0);
        b = context.getResourceId(cv.k.ViewStubCompat_android_inflatedId, -1);
        a = context.getResourceId(cv.k.ViewStubCompat_android_layout, 0);
        setId(context.getResourceId(cv.k.ViewStubCompat_android_id, -1));
        context.recycle();
        setVisibility(8);
        setWillNotDraw(true);
    }

...
public class SwitchCompat extends CompoundButton
{
    ...
    public SwitchCompat(Context context, AttributeSet attributeset, int i1)
    {
        ...
        attributeset = es.a(context, attributeset, cv.k.SwitchCompat, i1);
        a = attributeset.a(cv.k.SwitchCompat_android_thumb);
        if (a != null)
        {
            a.setCallback(this);
        }
        b = attributeset.a(cv.k.SwitchCompat_track);
        if (b != null)
        {
            b.setCallback(this);
        }
        g = attributeset.c(cv.k.SwitchCompat_android_textOn);
        h = attributeset.c(cv.k.SwitchCompat_android_textOff);
        i = attributeset.a(cv.k.SwitchCompat_showText, true);
        c = attributeset.c(cv.k.SwitchCompat_thumbTextPadding, 0);
        d = attributeset.c(cv.k.SwitchCompat_switchMinWidth, 0);
        e = attributeset.c(cv.k.SwitchCompat_switchPadding, 0);
        f = attributeset.a(cv.k.SwitchCompat_splitTrack, false);
        i1 = attributeset.e(cv.k.SwitchCompat_switchTextAppearance, 0);
        if (i1 != 0)
        {
    ...
    {
        switchcompat.setThumbPosition(f1);
    }
    ...
    private void setThumbPosition(float f1)
    {
        p = f1;
        invalidate();
    }
...
_L4:
    ...
    public void onMeasure(int i1, int j1)
    {
        ...
        {
            setMeasuredDimension(bh.k(this), k1);
        }
    }
...
_L8:
    ...
    {
        TypedArray typedarray = context.obtainStyledAttributes(i1, cv.k.TextAppearance);
        context = typedarray.getColorStateList(cv.k.TextAppearance_android_textColor);
        int j1;
        if (context != null)
        {
            y = context;
        ...
        i1 = typedarray.getDimensionPixelSize(cv.k.TextAppearance_android_textSize, 0);
        if (i1 != 0 && (float)i1 != x.getTextSize())
        {
            x.setTextSize(i1);
            requestLayout();
        }
        i1 = typedarray.getInt(cv.k.TextAppearance_android_typeface, -1);
        j1 = typedarray.getInt(cv.k.TextAppearance_android_textStyle, -1);
        i1;
...
_L5:
        ...
        if (typedarray.getBoolean(cv.k.TextAppearance_textAllCaps, false))
        {
            B = new df(getContext());
        } else
        {

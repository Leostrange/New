...
public class LinearLayoutCompat extends ViewGroup
{
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            h = -1;
            context = context.obtainStyledAttributes(attributeset, cv.k.LinearLayoutCompat_Layout);
            g = context.getFloat(cv.k.LinearLayoutCompat_Layout_android_layout_weight, 0.0F);
            h = context.getInt(cv.k.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            context.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeset, int i1)
    {
        ...
        c = 0;
        e = 0x800033;
        context = es.a(context, attributeset, cv.k.LinearLayoutCompat, i1);
        i1 = context.a(cv.k.LinearLayoutCompat_android_orientation, -1);
        if (i1 >= 0)
        {
            setOrientation(i1);
        }
        i1 = context.a(cv.k.LinearLayoutCompat_android_gravity, -1);
        if (i1 >= 0)
        {
            setGravity(i1);
        }
        boolean flag = context.a(cv.k.LinearLayoutCompat_android_baselineAligned, true);
        if (!flag)
        {
            setBaselineAligned(flag);
        }
        i1 = cv.k.LinearLayoutCompat_android_weightSum;
        g = ((es) (context)).a.getFloat(i1, -1F);
        b = context.a(cv.k.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        h = context.a(cv.k.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.a(cv.k.LinearLayoutCompat_divider));
        n = context.a(cv.k.LinearLayoutCompat_showDividers, 0);
        o = context.c(cv.k.LinearLayoutCompat_dividerPadding, 0);
...
_L2:
        ...
        l6 = bh.a(Math.max(f, getSuggestedMinimumWidth()), i1, 0);
        l2 = (0xffffff & l6) - f;
...
label0:
                ...
                while (i3 < k7) 
                {
                    ...
                    if (view2 != null && view2.getVisibility() != 8)
                    {
                        ...
                        if (f2 > 0.0F)
                        {
                            ...
                            k1 = eu.a(k1, bh.l(view2) & 0xff000000);
                            f1 -= f2;
                            l2 = k2 - k3;
                            k2 = k1;
                            k1 = l2;
            ...
            do
            {
                ...
                setMeasuredDimension(0xff000000 & j2 | l6, bh.a(Math.max(k1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j1, j2 << 16));
                if (flag)
                {
        ...
        {
            {
                ...
                int i6 = bh.a(Math.max(f, getSuggestedMinimumHeight()), j1, 0);
                ...
                while (i3 < k7) 
                {
                    ...
                    if (view1.getVisibility() != 8)
                    {
                        ...
                        if (f2 > 0.0F)
                        {
                            ...
                            k1 = eu.a(k1, bh.l(view1) & 0xffffff00);
                            l2 = k2 - i4;
                            k2 = k1;
                            f1 -= f2;
                            k1 = l2;
            ...
            setMeasuredDimension(bh.a(Math.max(l1 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i1, k1), i6);
            if (flag)
            {
                a(k7, j1);
            }

...
class CircularBorderDrawable extends Drawable
{
    ...
    private Shader createGradientShader()
    {
        ...
        int i = h.a(mTopOuterStrokeColor, mTintColor);
        int j = h.a(mTopInnerStrokeColor, mTintColor);
        int k = h.a(h.b(mTopInnerStrokeColor, 0), mTintColor);
        int l = h.a(h.b(mBottomInnerStrokeColor, 0), mTintColor);
        int i1 = h.a(mBottomInnerStrokeColor, mTintColor);
        int j1 = h.a(mBottomOuterStrokeColor, mTintColor);

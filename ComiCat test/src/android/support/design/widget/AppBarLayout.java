...
public class AppBarLayout extends LinearLayout
{
    public static class Behavior extends ViewOffsetBehavior
    {
        ...
        private boolean fling(CoordinatorLayout coordinatorlayout, AppBarLayout appbarlayout, int i, int j, float f)
        {
            ...
            if (mScroller == null)
            {
                mScroller = cs.a(appbarlayout.getContext(), null);
            }
            mScroller.a(getTopBottomOffsetForScrollingSibling(), 0, Math.round(f), 0, 0, i, j);
            if (mScroller.g())
            {
                mFlingRunnable = new FlingRunnable(coordinatorlayout, appbarlayout);
                bh.a(appbarlayout, mFlingRunnable);
                return true;
            } else
            {
                mFlingRunnable = null;
...
_L6:
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            if (mLayout != null && mScroller != null && mScroller.g())
            {
                setAppBarTopBottomOffset(mParent, mLayout, mScroller.c());
                bh.a(mLayout, this);
            }
        }
    ...
    public static class Behavior.SavedState extends android.view.View.BaseSavedState
    {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams
    {
        ...
        public LayoutParams(Context context, AttributeSet attributeset)
        {
            super(context, attributeset);
            mScrollFlags = 1;
            attributeset = context.obtainStyledAttributes(attributeset, a.h.AppBarLayout_LayoutParams);
            mScrollFlags = attributeset.getInt(a.h.AppBarLayout_LayoutParams_layout_scrollFlags, 0);
            if (attributeset.hasValue(a.h.AppBarLayout_LayoutParams_layout_scrollInterpolator))
            {
                mScrollInterpolator = AnimationUtils.loadInterpolator(context, attributeset.getResourceId(a.h.AppBarLayout_LayoutParams_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends ViewOffsetBehavior
    {
        ...
        {
            super(context, attributeset);
            context = context.obtainStyledAttributes(attributeset, a.h.ScrollingViewBehavior_Params);
            mOverlayTop = context.getDimensionPixelSize(a.h.ScrollingViewBehavior_Params_behavior_overlapTop, 0);
            context.recycle();
        }
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeset)
    {
        ...
        mDownScrollRange = -1;
        setOrientation(1);
        context = context.obtainStyledAttributes(attributeset, a.h.AppBarLayout, 0, a.g.Widget_Design_AppBarLayout);
        mTargetElevation = context.getDimensionPixelSize(a.h.AppBarLayout_elevation, 0);
        setBackgroundDrawable(context.getDrawable(a.h.AppBarLayout_android_background));
        context.recycle();
        ViewUtils.setBoundsViewOutlineProvider(this);
        mListeners = new ArrayList();
        bh.f(this, mTargetElevation);
        bh.a(this, new bc() {
...
_L2:
    ...
    final int getMinimumHeightForVisibleOverlappingContent()
    {
        ...
        } else
        {
            ...
            if (l > 0)
            {
                return bh.r(getChildAt(l - 1)) * 2 + i;
            }
        }
        return j;
    }

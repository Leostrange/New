...
public class SwipeDismissBehavior extends CoordinatorLayout.Behavior
{
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            if (mViewDragHelper != null && mViewDragHelper.c())
            {
                bh.a(mView, this);
            } else
...
_L7:
        ...
        public void onViewPositionChanged(View view, int i, int j, int k, int l)
        {
            ...
            {
                bh.c(view, SwipeDismissBehavior.clamp(0.0F, 1.0F - SwipeDismissBehavior.fraction(f, f1, i), 1.0F));
                return;
            }
        }
        ...
        public void onViewReleased(View view, float f, float f1)
        {
            ...
            if (mViewDragHelper.a(i, view.getTop()))
            {
                bh.a(view, new SettleRunnable(view, flag));
            } else
    ...
    private void ensureViewDragHelper(ViewGroup viewgroup)
    {
        if (mViewDragHelper == null)
        {
            if (mSensitivitySet)
            {
                viewgroup = cu.a(viewgroup, mSensitivity, mDragCallback);
            } else
            {
                viewgroup = cu.a(viewgroup, mDragCallback);
            }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorlayout, View view, MotionEvent motionevent)
    {
        ...
        } else
        {
            ...
            return mViewDragHelper.a(motionevent);
        }
        if (mIgnoreEvents)
        {
            mIgnoreEvents = false;

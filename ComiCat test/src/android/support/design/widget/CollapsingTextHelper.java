...
_L6:
    ...
    private boolean calculateIsRtl(CharSequence charsequence)
    {
        ...
        return y1.a(charsequence, charsequence.length());
    }
    ...
    {
        TypedArray typedarray = mView.getContext().obtainStyledAttributes(i, a.h.TextAppearance);
        if (typedarray.hasValue(a.h.TextAppearance_android_textColor))
        {
            mCollapsedTextColor = typedarray.getColor(a.h.TextAppearance_android_textColor, 0);
        }
        if (typedarray.hasValue(a.h.TextAppearance_android_textSize))
        {
            mCollapsedTextSize = typedarray.getDimensionPixelSize(a.h.TextAppearance_android_textSize, 0);
        }
        typedarray.recycle();
        recalculate();
    }
    ...
    final void setExpandedTextAppearance(int i)
    {
        ...
        if (typedarray.hasValue(a.h.TextAppearance_android_textColor))
        {
            mExpandedTextColor = typedarray.getColor(a.h.TextAppearance_android_textColor, 0);
        }
        if (typedarray.hasValue(a.h.TextAppearance_android_textSize))
        {
            mExpandedTextSize = typedarray.getDimensionPixelSize(a.h.TextAppearance_android_textSize, 0);
        }
        typedarray.recycle();
        recalculate();
    }

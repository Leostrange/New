    ...
    implements android.view.stener
{
    ...
    final void update()
    {
        ...
        if (mCustomView == null)
        {
            if (mIconView == null)
            {
                ImageView imageview = (ImageView)LayoutInflater.from(getContext()).inflate(n, this, false);
                addView(imageview, 0);
                mIconView = imageview;
            }
            if (mTextView == null)
            {
                TextView textview = (TextView)LayoutInflater.from(getContext()).inflate(t, this, false);
                addView(textview);
                mTextView = textview;
            }
    ...
    public (Context context,  )
    {
        ...
        {
            setBackgroundDrawable(er.a(context, TabLayout.access$200(TabLayout.this)));
        }
        bh.b(this, TabLayout.access$300(TabLayout.this), TabLayout.access$400(TabLayout.this), TabLayout.access$500(TabLayout.this), TabLayout.access$600(TabLayout.this));
        setGravity(17);
        update();
    }
}

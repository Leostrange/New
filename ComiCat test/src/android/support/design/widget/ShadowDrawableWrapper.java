...
class ShadowDrawableWrapper extends cz
{
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable drawable, float f, float f1, float f2)
    {
        ...
        mShadowStartColor = resources.getColor(a.c.shadow_start_color);
        mShadowMiddleColor = resources.getColor(a.c.shadow_mid_color);
        mShadowEndColor = resources.getColor(a.c.shadow_end_color);

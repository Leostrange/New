    ...
    implements ba
{
        ...
        implements bc
    {
        ...
        public final bw onApplyWindowInsets(View view, bw bw1)
        {
            setWindowInsets(bw1);
            return bw1.f();
        }
    ...
    public static abstract class Behavior
    {
        ...
        public bw onApplyWindowInsets(CoordinatorLayout coordinatorlayout, View view, bw bw1)
        {
            return bw1;
        }
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams
    {
        ...
        LayoutParams(Context context, AttributeSet attributeset)
        {
            ...
            mAnchorId = -1;
            mLastChildRect = new Rect();
            TypedArray typedarray = context.obtainStyledAttributes(attributeset, a.h.CoordinatorLayout_LayoutParams);
            gravity = typedarray.getInteger(a.h.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            mAnchorId = typedarray.getResourceId(a.h.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            anchorGravity = typedarray.getInteger(a.h.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            keyline = typedarray.getInteger(a.h.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            mBehaviorResolved = typedarray.hasValue(a.h.CoordinatorLayout_LayoutParams_layout_behavior);
            if (mBehaviorResolved)
            {
                mBehavior = CoordinatorLayout.parseBehavior(context, attributeset, typedarray.getString(a.h.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            typedarray.recycle();
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeset, int i)
    {
        ...
        mNestedScrollingParentHelper = new bb(this);
        attributeset = context.obtainStyledAttributes(attributeset, a.h.CoordinatorLayout, i, a.g.Widget_Design_CoordinatorLayout);
        i = attributeset.getResourceId(a.h.CoordinatorLayout_keylines, 0);
        if (i != 0)
        {
        ...
        mStatusBarBackground = attributeset.getDrawable(a.h.CoordinatorLayout_statusBarBackground);
    ...
    private void dispatchChildApplyWindowInsets(bw bw1)
    {
        if (!bw1.e()) goto _L2; else goto _L1
_L1:
        return;
_L2:
        int i;
...
_L3:
        ...
        bw1 = ((Behavior) (obj)).onApplyWindowInsets(this, view, bw1);
        if (bw1.e()) goto _L1; else goto _L4
_L4:
        obj = bh.b(view, bw1);
        if (((bw) (obj)).e()) goto _L1; else goto _L5
_L5:
        i++;
        bw1 = ((bw) (obj));
          goto _L6
    ...
    private void layoutChild(View view, int i)
    {
        ...
        if (mLastInsets != null && bh.x(this) && !bh.x(view))
        {
        ...
        ap.a(resolveGravity(layoutparams.gravity), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect1, i);
    ...
    private void layoutChildWithKeyline(View view, int i, int j)
    {
        ...
        l1 = ap.a(resolveKeylineGravity(layoutparams.gravity), j);
        k1 = getWidth();
        j1 = getHeight();
...
_L2:
    ...
    private void setWindowInsets(bw bw1)
    {
        boolean flag1 = true;
        if (mLastInsets != bw1)
        {
            ...
            setWillNotDraw(flag);
            dispatchChildApplyWindowInsets(bw1);
            requestLayout();
        }
    }
...
label1:
    ...
    void getDesiredAnchoredChildRect(View view, int i, Rect rect, Rect rect1)
    {
        ...
        int j1;
        layoutparams = (LayoutParams)view.getLayoutParams();
        j1 = ap.a(resolveAnchoredChildGravity(layoutparams.gravity), i);
        j = ap.a(resolveGravity(layoutparams.anchorGravity), i);
        l = view.getMeasuredWidth();
        i1 = view.getMeasuredHeight();
        j & 7;
...
_L3:
        ...
        l4 = ap.a(resolveKeylineGravity(layoutparams.gravity), j3) & 7;
...
_L8:
        k = Math.max(0, i2 - j2);
          goto _L2
        setMeasuredDimension(bh.a(k1, i, 0xff000000 & i1), bh.a(j1, j, i1 << 16));
        return;
    }
...
_L9:
    ...
    public void setStatusBarBackgroundResource(int i)
    {
        ...
        if (i != 0)
        {
            drawable = e.getDrawable(getContext(), i);
        } else
        {
            drawable = null;
        }

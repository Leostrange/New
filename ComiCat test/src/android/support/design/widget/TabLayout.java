...
public class TabLayout extends HorizontalScrollView
{
    ...
    class SlidingTabStrip extends LinearLayout
    {
        ...
        void animateIndicatorToPosition(int i, int j)
        {
            ...
            k = ((View) (obj)).getRight();
            if (Math.abs(i - mSelectedPosition) > 1) goto _L2; else goto _L1
_L1:
...
_L4:
            if (startLeft != targetLeft || startRight != k)
            {
                ...
                ((ValueAnimatorCompat) (obj)).setDuration(j);
                ((ValueAnimatorCompat) (obj)).setFloatValues(0.0F, 1.0F);
                ((ValueAnimatorCompat) (obj)).setUpdateListener(k. new ValueAnimatorCompat.AnimatorUpdateListener() {
            ...
            
            {
                ...
                ((ValueAnimatorCompat) (obj)).setListener(i. new ValueAnimatorCompat.AnimatorListenerAdapter() {
...
*/
    ...
    public static final class Tab
    {
        ...
        {
            return setIcon(er.a(mParent.getContext(), i));
        }
        ...
        implements android.view.View.OnLongClickListener
    {
        ...
        public TabView(Context context, Tab tab)
        {
            ...
            {
                setBackgroundDrawable(er.a(context, mTabBackgroundResId));
            }
            bh.b(this, mTabPaddingStart, mTabPaddingTop, mTabPaddingEnd, mTabPaddingBottom);
            setGravity(17);
            update();
        }
    }
    ...
    public TabLayout(Context context, AttributeSet attributeset, int i)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, a.h.TabLayout, i, a.g.Widget_Design_TabLayout);
        mTabStrip.setSelectedIndicatorHeight(context.getDimensionPixelSize(a.h.TabLayout_tabIndicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(context.getColor(a.h.TabLayout_tabIndicatorColor, 0));
        mTabTextAppearance = context.getResourceId(a.h.TabLayout_tabTextAppearance, a.g.TextAppearance_Design_Tab);
        i = context.getDimensionPixelSize(a.h.TabLayout_tabPadding, 0);
        mTabPaddingBottom = i;
        mTabPaddingEnd = i;
        mTabPaddingTop = i;
        mTabPaddingStart = i;
        mTabPaddingStart = context.getDimensionPixelSize(a.h.TabLayout_tabPaddingStart, mTabPaddingStart);
        mTabPaddingTop = context.getDimensionPixelSize(a.h.TabLayout_tabPaddingTop, mTabPaddingTop);
        mTabPaddingEnd = context.getDimensionPixelSize(a.h.TabLayout_tabPaddingEnd, mTabPaddingEnd);
        mTabPaddingBottom = context.getDimensionPixelSize(a.h.TabLayout_tabPaddingBottom, mTabPaddingBottom);
        mTabTextColors = loadTextColorFromTextAppearance(mTabTextAppearance);
        if (context.hasValue(a.h.TabLayout_tabTextColor))
        {
            mTabTextColors = context.getColorStateList(a.h.TabLayout_tabTextColor);
        }
        if (context.hasValue(a.h.TabLayout_tabSelectedTextColor))
        {
            i = context.getColor(a.h.TabLayout_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), i);
        }
        mTabMinWidth = context.getDimensionPixelSize(a.h.TabLayout_tabMinWidth, 0);
        mRequestedTabMaxWidth = context.getDimensionPixelSize(a.h.TabLayout_tabMaxWidth, 0);
        mTabBackgroundResId = context.getResourceId(a.h.TabLayout_tabBackground, 0);
        mContentInsetStart = context.getDimensionPixelSize(a.h.TabLayout_tabContentStart, 0);
        mMode = context.getInt(a.h.TabLayout_tabMode, 1);
        mTabGravity = context.getInt(a.h.TabLayout_tabGravity, 0);
        context.recycle();
        applyModeAndGravity();
    }
    ...
    private void animateToTab(int i)
    {
        ...
        if (getWindowToken() == null || !bh.C(this) || mTabStrip.childrenNeedLayout())
        {
...
_L4:
    ...
    {
        TypedArray typedarray = getContext().obtainStyledAttributes(i, a.h.TextAppearance);
        ColorStateList colorstatelist = typedarray.getColorStateList(a.h.TextAppearance_android_textColor);
        typedarray.recycle();
...
_L4:
    ...
    public void setTabsFromPagerAdapter(bd bd1)
    {
        removeAllTabs();
        int i = 0;
        for (int j = bd1.getCount(); i < j; i++)
        {
            addTab(newTab().setText(bd1.getPageTitle(i)));
        }
    ...
    {
        Object obj = viewpager.getAdapter();
        if (obj == null)
        {
            throw new IllegalArgumentException("ViewPager does not have a PagerAdapter set");
        }
        setTabsFromPagerAdapter(((bd) (obj)));
        obj = new TabLayoutOnPageChangeListener(this);
        if (viewpager.a == null)
        {

    ...
    public static class Behavior extends CoordinatorLayout.Behavior
    {
        ...
        private float getFabTranslationYForSnackbar(CoordinatorLayout coordinatorlayout, FloatingActionButton floatingactionbutton)
        {
            ...
            for (int i = 0; i < j; i++)
            {
                ...
                {
                    f = Math.min(f, bh.p(view) - (float)view.getHeight());
                }
            }
...
_L3:
        ...
        public void onDependentViewRemoved(CoordinatorLayout coordinatorlayout, FloatingActionButton floatingactionbutton, View view)
        {
            ...
            {
                bh.s(floatingactionbutton).c(0.0F).a(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).a(null);
            }
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = context.obtainStyledAttributes(attributeset, a.h.FloatingActionButton, i, a.g.Widget_Design_FloatingActionButton);
        context = attributeset.getDrawable(a.h.FloatingActionButton_android_background);
        mBackgroundTint = attributeset.getColorStateList(a.h.FloatingActionButton_backgroundTint);
        mBackgroundTintMode = parseTintMode(attributeset.getInt(a.h.FloatingActionButton_backgroundTintMode, -1), null);
        mRippleColor = attributeset.getColor(a.h.FloatingActionButton_rippleColor, 0);
        mSize = attributeset.getInt(a.h.FloatingActionButton_fabSize, 0);
        mBorderWidth = attributeset.getDimensionPixelSize(a.h.FloatingActionButton_borderWidth, 0);
        float f = attributeset.getDimension(a.h.FloatingActionButton_elevation, 0.0F);
        float f1 = attributeset.getDimension(a.h.FloatingActionButton_pressedTranslationZ, 0.0F);
        ...
        i = (int)getResources().getDimension(a.d.fab_content_size);

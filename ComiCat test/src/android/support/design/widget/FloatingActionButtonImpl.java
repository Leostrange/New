...
abstract class FloatingActionButtonImpl
{
    ...
    Drawable createBorderDrawable(int i, ColorStateList colorstatelist)
    {
        ...
        circularborderdrawable.setGradientColors(resources.getColor(a.c.fab_stroke_top_outer_color), resources.getColor(a.c.fab_stroke_top_inner_color), resources.getColor(a.c.fab_stroke_end_inner_color), resources.getColor(a.c.fab_stroke_end_outer_color));

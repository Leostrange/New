...
public class VersionInfo
{
    ...
    public static String getUserAgent(String s, String s1, Class class1)
    {
        ...
        return String.format("%s/%s (Java/%s)", new Object[] {
            s, s1, System.getProperty("java.version")
        });
    }
    ...
    public static VersionInfo loadVersionInfo(String s, ClassLoader classloader)
    {
        ...
        inputstream = classloader1.getResourceAsStream((new StringBuilder()).append(s.replace('.', '/')).append("/version.properties").toString());
        if (inputstream == null)
        {
